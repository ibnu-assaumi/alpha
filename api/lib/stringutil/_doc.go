...
// Package stringutil of shared (version 1) is a package that handle anything about string such as :
// * camel case to snake case, this kind of helper is needed to convert order by parameter from camel cased to snake cased
package stringutil
