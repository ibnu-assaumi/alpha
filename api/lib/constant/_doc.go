...
// Package constant of shared (version 1) is a package which contain list of constants variable
// so it can be reuse for others such as date time layout, status of record, etc.
package constant
