...
// Package charlie of domain (version 1) is a package which represent model of data storage (sql/nosql)
// and parameters which required to get and/or modify charlie data
package charlie
