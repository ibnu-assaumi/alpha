...
func (impl delivery) UpdateCharlie(ctx context.Context, param domainCharlie.ParamUpdate) response.Response {
	const (
		operationName  string = "Delivery_UpdateCharlie"
	...
	result := impl.charlieUseCase.UpdateCharlie(spanCTX, param)
