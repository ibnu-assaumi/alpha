...
// Package middleware of echo is a package to use echo middleware and/or custom middleware,
// it could implement echo middleware or create the custom middleware function to intercept the request.
package middleware
